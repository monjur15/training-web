...
const AdminBlog = () => {
    ...
    let getData = (event) => {
        const blogTitleValue = event.target.value;
        ...
        <div>
            <div className="container py-5">
                ...
                <form action="">
                    ...
                    <div className='w-90'>
                        <textarea class="contact-form-text" placeholder="Description" onChange={getDes}></textarea>
                    </div>
                    <label for="fname">Author:</label>
                    <input type="text" id="author" name="author" onChange={getAuthor}></input>
                    <br /><br />
