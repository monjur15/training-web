        ...
        <div>
            <div className="container py-5">
                ...
                <form action="">
                    ...
                    <input type="text" id="name" name="name" onChange={getReviewer}></input>
                    <br /><br />
                    <label for="fname">Designation:</label>
                    <input type="text" id="desig" name="desig" onChange={getRevieDesig}></input>
                    <div className='w-90'>
                        <textarea class="contact-form-text" placeholder="Description" onChange={getRevieDescrip}></textarea>
                    </div>


                    <label for="img">Select image:</label>
                    <input type="file" id="img" name="img" accept="image/*" onChange={getReviewImg}></input>
