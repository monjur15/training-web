            ...
            <div className="course_card p-3 my-5 flex flex-col items-center">
              ...
              <div className="course_description pt-3 px-3 font-pangramRegular">
                ...
                <p>
                  ...
                  problems on the fly. NodeJS is quickly becoming one of the
                  most popular web technology stacks. It aids in the development
                  of scalable and rapid network applications. With this
                  technology, web apps can be created quickly and efficiently,
                  and they can be distributed to the cloud with simplicity. This
                  course provides a thorough overview of server-side web
                  development fundamentals. The many components that make up a
                  website or web application's backend, as well as the Node.js
                  runtime configuration, will be discussed. After finishing this
                  course, you'll be ready to explore standard Node frameworks
                  like Express.js and build powerful apps. This course
                  necessitates a thorough knowledge of JavaScript. It is
                  preferable, but not required, to have prior experience with
