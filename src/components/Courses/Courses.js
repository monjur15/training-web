    ...
    <div className="pl-28 py-16 relative">
      ...
      <div className="w-full h-80 flex">
          ...
          <div className="flex">
            <div className="flex">
              {/* <div className="relative">
                <div className="w-5 h-5 rounded-full bg-black -left-2 absolute"></div>
                <div className="w-1 h-48 bg-black"></div>
                <IoIosArrowDropup className="w-12 h-12 -left-5 absolute hover:text-SearchBg transition-all duration-200" />
                <IoIosArrowDropdown className="w-12 h-12 -left-5 -bottom-32 absolute hover:text-SearchBg bottom-6 transition-all duration-200" />
              </div> */}
        ...
        <div className="w-2/5 h-80 relative">
          ...
          <div className="w-80 h-64 course_img_bg z-10 absolute top-10 left-16 rounded-4xl flex justify-center">
            <img src={devops1} className="-rotate-45 w-5/6"></img>
          </div>
        </div>
      </div>
    </div>
